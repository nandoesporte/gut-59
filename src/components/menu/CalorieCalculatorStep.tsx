...
export const CalorieCalculatorStep = ({
  ...
  return (
    <Card className="p-4 sm:p-6 bg-primary-50 border border-primary-100">
      <div className="text-center mb-4 sm:mb-6">
        <h2 className="text-xl sm:text-2xl font-semibold text-primary-600">Objetivo do Cardápio</h2>
      ...
      {calorieNeeds === null ? (
        ...
        <div className="flex flex-col items-center justify-center py-6 sm:py-8 space-y-4">
          ...
          <p className="text-base sm:text-lg font-medium text-primary-700">
