  ...
  const handleDietaryPreferences = async (preferences: DietaryPreferences) => {    
    ...
    try {
      ...
      if (userData.user) {
        ...
        toast.loading("Gerando plano alimentar personalizado com Nutri+...");
        ...
        try {
          ...
          if (generatedMealPlan) {
            ...
            console.log('Plano gerado pelo Nutri+ agent:', generatedMealPlan);
        ...
        console.log("Usuário não autenticado. É necessário login para gerar um plano personalizado.");
        toast.error("É necessário fazer login para gerar um plano personalizado completo.");
        setLoading(false);
        return false;
      }
