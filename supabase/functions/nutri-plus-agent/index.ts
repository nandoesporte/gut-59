...
function createFallbackMealPlan(userData, selectedFoods) {
  ...
  // Enhance the plan by adding salads and maximizing variety
  return enhanceMealPlanVariety(fallbackPlan);
}

// Function to enhance meal plan variety by adding salads and maximizing food variety
function enhanceMealPlanVariety(mealPlan) {
  ...
  if (mealPlan.weeklyPlan) {
    ...
    // Recalculate weekly totals after modifications
    mealPlan.weeklyTotals = calculateWeeklyTotals(mealPlan.weeklyPlan);
  }
